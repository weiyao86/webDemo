(function(n, t) {
	...
	function nr(n, r, u, f) {
		if (i.acceptData(n)) {
			var s, h, c = i.expando,
				...
				o = l ? i.cache : n,
				e = l ? n[c] : n[c] && c;
			if (e && o[e] && (f || o[e].data) || !a || u !== t) return e || (l ? n[c] = e = p.pop() || i.guid++ : e = c), o[e] || (o[e] = {}, l || (o[e].toJSON = i.noop)), (typeof r == "object" || typeof r == "function") && (f ? o[e] = i.extend(o[e], r) : o[e].data = i.extend(o[e].data, r)), s = o[e], f || (s.data || (s.data = {}), s = s.data), u !== t && (s[i.camelCase(r)] = u), a ? (h = s[r], h == null && (h = s[i.camelCase(r)])) : h = s, h
		}
	}
		...
		if (i.acceptData(n)) {
			...
			if (u[f]) {
				if (t && (e = r ? u[f] : u[f].data, e)) {
					...
					if (!(r ? gt : i.isEmptyObject)(e)) return
				}(r || (delete u[f].data, gt(u[f]))) && (s ? i.cleanData([n], !0) : i.support.deleteExpando || u != u.window ? delete u[f] : u[f] = null)
			}
		}
	}
	...
	function ir(n, r, u) {
		if (u === t && n.nodeType === 1) {
			var f = "data-" + r.replace(gi, "-$1").toLowerCase();
			if (u = n.getAttribute(f), typeof u == "string") {
				try {
					u = u === "true" ? !0 : u === "false" ? !1 : u === "null" ? null : +u + "" === u ? +u : di.test(u) ? i.parseJSON(u) : u
				} catch (e) {}
				i.data(n, r, u)
			} else u = t
		}
	...
	function hr(n, t, r) {
		...
		if (typeof t == "string") {
			...
			if (re.test(t)) return i.filter(t, u, !r);
			t = i.filter(t, u)
		}
	...
	function ve(n, t) {
		...
		if (t.nodeType === 1) {
			...
			r === "script" && t.text !== n.text ? (br(t).text = n.text, kr(t)) : r === "object" ? (t.parentNode && (t.outerHTML = n.outerHTML), i.support.html5Clone && n.innerHTML && !i.trim(t.innerHTML) && (t.innerHTML = n.innerHTML)) : r === "input" && fi.test(n.type) ? (t.defaultChecked = t.checked = n.checked, t.value !== n.value && (t.value = n.value)) : r === "option" ? t.defaultSelected = t.selected = n.defaultSelected : (r === "input" || r === "textarea") && (t.defaultValue = n.defaultValue)
		}
	}

	function u(n, r) {
		var o, e, s = 0,
			f = typeof n.getElementsByTagName != "undefined" ? n.getElementsByTagName(r || "*") : typeof n.querySelectorAll != "undefined" ? n.querySelectorAll(r || "*") : t;
		if (!f)
			for (f = [], o = n.childNodes || n;
				(e = o[s]) != null; s++) !r || i.nodeName(e, r) ? f.push(e) : i.merge(f, u(e, r));
		return r === t || r && i.nodeName(n, r) ? i.merge([n], f) : f
	}

	function ye(n) {
		fi.test(n.type) && (n.defaultChecked = n.checked)
	}

	function ru(n, t) {
		if (t in n) return t;
		for (var r = t.charAt(0).toUpperCase() + t.slice(1), u = t, i = iu.length; i--;)
			if (t = iu[i] + r, t in n) return t;
		return u
	}
	...
	function uu(n, t) {
		for (var r, f = [], u = 0, e = n.length; u < e; u++)(r = n[u], r.style) && (f[u] = i._data(r, "olddisplay"), t ? (f[u] || r.style.display !== "none" || (r.style.display = ""), r.style.display === "" && tt(r) && (f[u] = i._data(r, "olddisplay", su(r.nodeName)))) : f[u] || tt(r) || i._data(r, "olddisplay", i.css(r, "display")));
		for (u = 0; u < e; u++)(r = n[u], r.style) && (t && r.style.display !== "none" && r.style.display !== "" || (r.style.display = t ? f[u] || "" : "none"));
		return n
	}
	...
	function eu(n, t, r, u, f) {
		for (var e = r === (u ? "border" : "content") ? 4 : t === "width" ? 1 : 0, o = 0; e < 4; e += 2) r === "margin" && (o += i.css(n, r + v[e], !0, f)), u ? (r === "content" && (o -= i.css(n, "padding" + v[e], !0, f)), r !== "margin" && (o -= i.css(n, "border" + v[e] + "Width", !0, f))) : (o += i.css(n, "padding" + v[e], !0, f), r !== "padding" && (o += i.css(n, "border" + v[e] + "Width", !0, f)));
		return o
	}
	...
	function ou(n, t, r) {
		...
		if (u <= 0 || u == null) {
			if (u = l(n, t, f), (u < 0 || u == null) && (u = n.style[t]), st.test(u)) return u;
			e = o && (i.support.boxSizingReliable || u === n.style[t]);
			u = parseFloat(u) || 0
		}
		return u + eu(n, t, r || (o ? "border" : "content"), e, f) + "px"
	}

	function su(n) {
		var u = r,
			t = nu[n];
		return t || (t = hu(n, u), t !== "none" && t || (nt = (nt || i("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(u.documentElement), u = (nt[0].contentWindow || nt[0].contentDocument).document, u.write("<!doctype html><html><body>"), u.close(), t = hu(n, u), nt.detach()), nu[n] = t), t
	}
	...
	function hi(n, t, r, u) {
		...
		if (i.isArray(t)) i.each(t, function(t, i) {
			r || to.test(n) ? u(n, i) : hi(n + "[" + (typeof i == "object" ? t : "") + "]", i, r, u)
		});
		else if (r || i.type(t) !== "object") u(n, t);
		else
			for (f in t) hi(n + "[" + f + "]", t[f], r, u)
	}
	...
	function yo(n, t) {
		i.each(t, function(t, i) {
			for (var u = (it[t] || []).concat(it["*"]), r = 0, f = u.length; r < f; r++)
	...
	function nf(n, t, r) {
		var e, o, s = 0,
			...
			c = function() {
				if (o) return !1;
				for (var s = g || gu(), t = Math.max(0, u.startTime + u.duration - s), h = t / u.duration || 0, i = 1 - h, r = 0, e = u.tweens.length; r < e; r++) u.tweens[r].run(i);
			...
			h = u.props;
		for (po(h, u.opts.specialEasing); s < l; s++)
			if (e = at[s].call(u, n, h, u.opts), e) return e;
		return yo(u, h), i.isFunction(u.opts.start) && u.opts.start.call(n, u), i.fx.timer(i.extend(c, {
			elem: n,
			anim: u,
			queue: u.opts.queue
	...
	function wo(n, t, r) {
		...
		n.nodeType === 1 && ("height" in t || "width" in t) && (r.overflow = [e.overflow, e.overflowX, e.overflowY], i.css(n, "display") === "inline" && i.css(n, "float") === "none" && (i.support.inlineBlockNeedsLayout && su(n.nodeName) !== "inline" ? e.zoom = 1 : e.display = "inline-block"));
	...
	i.fn = i.prototype = {
		...
		init: function(n, u, f) {
			...
			if (!n) return this;
			if (typeof n == "string") {
				if (e = n.charAt(0) === "<" && n.charAt(n.length - 1) === ">" && n.length >= 3 ? [null, n, null] : sf.exec(n), e && (e[1] || !u)) {
					if (e[1]) {
						if (u = u instanceof i ? u[0] : u, i.merge(this, i.parseHTML(e[1], u && u.nodeType ? u.ownerDocument || u : r, !0)), ki.test(e[1]) && i.isPlainObject(u))
	...
	i.extend({
		...
		type: function(n) {
			return n == null ? String(n) : typeof n == "object" || typeof n == "function" ? ut[ef.call(n)] || "object" : typeof n
		},
		...
		parseJSON: function(t) {
			...
			if (t === null) return t;
			if (typeof t == "string" && (t = i.trim(t), t && hf.test(t.replace(lf, "@").replace(af, "]").replace(cf, "")))) return new Function("return " + t)();
		...
		trim: bt && !bt.call("﻿ ") ? function(n) {
			...
			return n == null ? "" : (n + "").replace(of, "")
		},
		makeArray: function(n, t) {
			var r = t || [];
			return n != null && (kt(Object(n)) ? i.merge(r, typeof n == "string" ? [n] : n) : pt.call(r, n)), r
		},
		inArray: function(n, t, i) {
			var r;
			if (t) {
				if (bi) return bi.call(t, n, i);
		...
		proxy: function(n, r) {
			var f, e, u;
			return (typeof r == "string" && (f = n[r], r = n, n = f), !i.isFunction(n)) ? t : (e = h.call(arguments, 2), u = function() {
	...
	i.ready.promise = function(t) {
		if (!rt)
			if (rt = i.Deferred(), r.readyState === "complete") setTimeout(i.ready);
	...
	i.Callbacks = function(n) {
		n = typeof n == "string" ? dt[n] || wf(n) : i.extend({}, n);
		var f, c, o, l, s, e, r = [],
			u = !n.once && [],
			a = function(t) {
	...
	i.extend({
		...
		when: function(n) {
			var t = 0,
				...
				o, l, s;
			if (r > 1)
				for (o = new Array(r), l = new Array(r), s = new Array(r); t < r; t++) u[t] && i.isFunction(u[t].promise) ? u[t].promise().done(c(t, s, u)).fail(f.reject).progress(c(t, l, o)) : --e;
			return e || f.resolveWith(s, u), f.promise()
		}
	});
	i.support = function() {
		var u, o, e, s, h, f, c, l, v, a, t = r.createElement("div");
		if (t.setAttribute("className", "t"), t.innerHTML = "  <link/><table><\/table><a href='/a'>a<\/a><input type='checkbox'/>", o = t.getElementsByTagName("*"), e = t.getElementsByTagName("a")[0], !o || !e || !o.length) return {};
		s = r.createElement("select");
		h = s.appendChild(r.createElement("option"));
		...
		for (a in {
				...
				change: !0,
				focusin: !0
			}) t.setAttribute(l = "on" + a, "t"), u[a + "Bubbles"] = l in n || t.attributes[l].expando === !1;
	...
	i.extend({
		...
		hasData: function(n) {
			return n = n.nodeType ? i.cache[n[i.expando]] : n[i.expando], !!n && !gt(n)
		},
		data: function(n, t, i) {
			return nr(n, t, i, !1)
		},
		...
		data: function(n, r) {
			...
			if (n === t) {
				if (this.length && (s = i.data(u), u.nodeType === 1 && !i._data(u, "parsedAttrs"))) {
					for (e = u.attributes; o < e.length; o++) f = e[o].name, f.indexOf("data-") || (f = i.camelCase(f.substring(5)), ir(u, f, s[f]));
			...
			return typeof n == "object" ? this.each(function() {
				...
				if (r === t) return u ? ir(u, n, i.data(u, n)) : null;
				this.each(function() {
					i.data(this, n, r)
				})
	...
	var w, rr, ni = /[\t\r\n]/g,
		...
		df = /^(?:a|area)$/i,
		ur = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,
	...
	i.fn.extend({
		...
		addClass: function(n) {
			...
			if (c)
				for (e = (n || "").match(o) || []; f < h; f++)
					if (t = this[f], r = t.nodeType === 1 && (t.className ? (" " + t.className + " ").replace(ni, " ") : " "), r) {
						for (s = 0; u = e[s++];) r.indexOf(" " + u + " ") < 0 && (r += u + " ");
		...
		removeClass: function(n) {
			...
			if (c)
				for (e = (n || "").match(o) || []; f < h; f++)
					if (r = this[f], t = r.nodeType === 1 && (r.className ? (" " + r.className + " ").replace(ni, " ") : ""), t) {
						for (s = 0; u = e[s++];)
		...
		hasClass: function(n) {
			for (var i = " " + n + " ", t = 0, r = this.length; t < r; t++)
				if (this[t].nodeType === 1 && (" " + this[t].className + " ").replace(ni, " ").indexOf(i) >= 0) return !0;
			return !1
		},
		val: function(n) {
			var r, u, e, f = this[0];
	...
	i.extend({
		...
		attr: function(n, r, u) {
			var f, e, o, s = n.nodeType;
			if (n && s !== 3 && s !== 8 && s !== 2) {
				if (typeof n.getAttribute == "undefined") return i.prop(n, r, u);
				if (o = s !== 1 || !i.isXMLDoc(n), o && (r = r.toLowerCase(), e = i.attrHooks[r] || (ur.test(r) ? rr : w)), u !== t)
					if (u === null) i.removeAttr(n, r);
					else return e && o && "set" in e && (f = e.set(n, u, r)) !== t ? f : (n.setAttribute(r, u + ""), u);
				else return e && o && "get" in e && (f = e.get(n, r)) !== null ? f : (typeof n.getAttribute != "undefined" && (f = n.getAttribute(r)), f == null ? t : f)
			}
		},
		removeAttr: function(n, t) {
			var r, u, e = 0,
				f = t && t.match(o);
			if (f && n.nodeType === 1)
				while (r = f[e++]) u = i.propFix[r] || r, ur.test(r) ? !c && ti.test(r) ? n[i.camelCase("default-" + r)] = n[u] = !1 : n[u] = !1 : i.attr(n, r, ""), n.removeAttribute(c ? r : u)
		},
		attrHooks: {
			type: {
				set: function(n, t) {
		...
		propHooks: {
			tabIndex: {
				get: function(n) {
					...
					return i && i.specified ? parseInt(i.value, 10) : kf.test(n.nodeName) || df.test(n.nodeName) && n.href ? 0 : t
				}
			}
		}
	});
	rr = {
		get: function(n, r) {
			var u = i.prop(n, r),
				...
				e = typeof u == "boolean" ? ii && c ? f != null : ti.test(r) ? n[i.camelCase("default-" + r)] : !!f : n.getAttributeNode(r);
			return e && e.value !== !1 ? r.toLowerCase() : t
		},
		set: function(n, t, r) {
			return t === !1 ? i.removeAttr(n, r) : ii && c || !ti.test(r) ? n.setAttribute(!c && i.propFix[r] || r, r) : n[i.camelCase("default-" + r)] = n[r] = !0, r
		}
	};
	ii && c || (i.attrHooks.value = {
		get: function(n, r) {
		...
		set: function(n, t, r) {
			...
			else return w && w.set(n, t, r)
		}
	});
	c || (w = i.valHooks.button = {
		get: function(n, i) {
	...
	var ri = /^(?:input|select|textarea)$/i,
		gf = /^key/,
	...
	i.event = {
		...
		add: function(n, r, u, f, e) {
			var y, c, w, p, b, l, h, a, s, k, d, v = n.nodeType !== 3 && n.nodeType !== 8 && i._data(n);
			if (v) {
				for (u.handler && (y = u, u = y.handler, e = y.selector), u.guid || (u.guid = i.guid++), (p = v.events) || (p = v.events = {}), (c = v.handle) || (c = v.handle = function(n) {
					...
					}, c.elem = n), r = (r || "").match(o) || [""], b = r.length; b--;) w = er.exec(r[b]) || [], s = d = w[1], k = (w[2] || "").split(".").sort(), h = i.event.special[s] || {}, s = (e ? h.delegateType : h.bindType) || s, h = i.event.special[s] || {}, l = i.extend({
					type: s,
					origType: d,
					data: f,
					handler: u,
		...
		remove: function(n, t, r, u, f) {
			var y, b, h, a, p, s, c, l, e, w, k, v = i.hasData(n) && i._data(n);
			if (v && (a = v.events)) {
				for (t = (t || "").match(o) || [""], p = t.length; p--;) {
					...
					for (c = i.event.special[e] || {}, e = (u ? c.delegateType : c.bindType) || e, l = a[e] || [], h = h[2] && new RegExp("(^|\\.)" + w.join("\\.(?:.*\\.|)") + "(\\.|$)"), b = y = l.length; y--;) s = l[y], (f || k === s.origType) && (!r || r.guid === s.guid) && (!h || h.test(s.namespace)) && (!u || u === s.selector || u === "**" && s.selector) && (l.splice(y, 1), s.selector && l.delegateCount--, c.remove && c.remove.call(n, s));
		...
		trigger: function(u, f, e, o) {
			...
			if ((h = c = e = e || r, e.nodeType !== 3 && e.nodeType !== 8) && !fr.test(s + i.event.triggered) && (s.indexOf(".") >= 0 && (y = s.split("."), s = y.shift(), y.sort()), a = s.indexOf(":") < 0 && "on" + s, u = u[i.expando] ? u : new i.Event(s, typeof u == "object" && u), u.isTrigger = !0, u.namespace = y.join("."), u.namespace_re = u.namespace ? new RegExp("(^|\\.)" + y.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, u.result = t, u.target || (u.target = e), f = f == null ? [u] : i.makeArray(f, [u]), l = i.event.special[s] || {}, o || !l.trigger || l.trigger.apply(e, f) !== !1)) {
				if (!o && !l.noBubble && !i.isWindow(e)) {
					for (w = l.delegateType || s, fr.test(w + s) || (h = h.parentNode); h; h = h.parentNode) b.push(h), c = h;
					c === (e.ownerDocument || r) && b.push(c.defaultView || c.parentWindow || n)
				}
				for (p = 0;
					(h = b[p++]) && !u.isPropagationStopped();) u.type = p > 1 ? w : l.bindType || s, v = (i._data(h, "events") || {})[u.type] && i._data(h, "handle"), v && v.apply(h, f), v = a && h[a], v && i.acceptData(h) && v.apply && v.apply(h, f) === !1 && u.preventDefault();
				if (u.type = s, !o && !u.isDefaultPrevented() && (!l._default || l._default.apply(e.ownerDocument, f) === !1) && !(s === "click" && i.nodeName(e, "a")) && i.acceptData(e) && a && e[s] && !i.isWindow(e)) {
					c = e[a];
					c && (e[a] = null);
					i.event.triggered = s;
					try {
		...
		dispatch: function(n) {
			...
			if (l[0] = n, n.delegateTarget = this, !f.preDispatch || f.preDispatch.call(this, n) !== !1) {
				for (c = i.event.handlers.call(this, n, a), o = 0;
					(u = c[o++]) && !n.isPropagationStopped();)
					for (n.currentTarget = u.elem, s = 0;
						(r = u.handlers[s++]) && !n.isImmediatePropagationStopped();)(!n.namespace_re || n.namespace_re.test(r.namespace)) && (n.handleObj = r, n.data = r.data, e = ((i.event.special[r.origType] || {}).handle || r.handler).apply(u.elem, l), e !== t && (n.result = e) === !1 && (n.preventDefault(), n.stopPropagation()));
			...
			if (h && u.nodeType && (!n.button || n.type !== "click"))
				for (; u != this; u = u.parentNode || this)
					if (u.disabled !== !0 || n.type !== "click") {
						for (f = [], o = 0; o < h; o++) s = r[o], e = s.selector + " ", f[e] === t && (f[e] = s.needsContext ? i(e, this).index(u) >= 0 : i.find(e, this, null, [u]).length), f[e] && f.push(s);
						f.length && c.push({
							elem: u,
							handlers: f
						})
	...
	i.Event = function(n, t) {
		...
		n && n.type ? (this.originalEvent = n, this.type = n.type, this.isDefaultPrevented = n.defaultPrevented || n.returnValue === !1 || n.getPreventDefault && n.getPreventDefault() ? ot : b) : this.type = n;
		t && i.extend(this, t);
	...
	i.Event.prototype = {
		...
		preventDefault: function() {
			...
			(this.isDefaultPrevented = ot, n) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1)
		},
		stopPropagation: function() {
			var n = this.originalEvent;
			(this.isPropagationStopped = ot, n) && (n.stopPropagation && n.stopPropagation(), n.cancelBubble = !0)
		},
	...
	i.support.changeBubbles || (i.event.special.change = {
		setup: function() {
			if (ri.test(this.nodeName)) return (this.type === "checkbox" || this.type === "radio") && (i.event.add(this, "propertychange._change", function(n) {
			...
			i.event.add(this, "beforeactivate._change", function(n) {
				var t = n.target;
				ri.test(t.nodeName) && !i._data(t, "changeBubbles") && (i.event.add(t, "change._change", function(n) {
		...
		teardown: function() {
			return i.event.remove(this, "._change"), !ri.test(this.nodeName)
		}
	});
	...
	i.fn.extend({
		on: function(n, r, u, f, e) {
			...
			if (u == null && f == null ? (f = r, u = r = t) : f == null && (typeof r == "string" ? (f = u, u = t) : (f = u, u = r, r = t)), f === !1) f = b;
		...
		off: function(n, r, u) {
			...
			return (r === !1 || typeof r == "function") && (u = r, r = t), u === !1 && (u = b), this.each(function() {
	...
	i.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function(n, t) {
			...
			gf.test(t) && (i.event.fixHooks[t] = i.event.keyHooks);
			ne.test(t) && (i.event.fixHooks[t] = i.event.mouseHooks)
		}),
		function(n, t) {
			function ti(n) {
				return tr.test(n + "")
			...
			function u(n, t, i, r) {
				...
				if (!c && !r) {
					...
					if (o.qsa && !a.test(n)) {
						...
						if (b) try {
							return ft.apply(i, et.call(d.querySelectorAll(b), 0)), i
						} catch (g) {} finally {
			...
			function fi(n, t, i, r, u, e) {
				return r && !r[f] && (r = fi(r)), u && !u[f] && (u = fi(u, e)), l(function(f, e, o, s) {
					...
					} else h = wt(h === e ? h.splice(w, h.length) : h), u ? u(null, e, h, s) : ft.apply(e, h)
				})
			}
				...
				var f = 0,
					...
					o = function(o, h, c, l, a) {
						...
						if (d += y, i && y !== d) {
							...
							ft.apply(l, w);
							nt && !o && w.length > 0 && d + t.length > 1 && u.uniqueSort(l)
						}
			...
			function lr(n, t, i, u) {
				var e, f, o, h, l, s = yt(n);
				if (!u && s.length === 1) {
					if (f = s[0] = s[0].slice(0), f.length > 2 && (o = f[0]).type === "ID" && t.nodeType === 9 && !c && r.relative[f[1].type]) {
						if (t = r.find.ID(o.matches[0].replace(p, w), t)[0], !t) return i;
						n = n.slice(f.shift().value.length)
					}
					for (e = vt.needsContext.test(n) ? -1 : f.length - 1; e >= 0; e--) {
						if (o = f[e], r.relative[h = o.type]) break;
						if ((l = r.find[h]) && (u = l(o.matches[0].replace(p, w), ni.test(f[0].type) && t.parentNode || t))) {
							if (f.splice(e, 1), n = u.length && pt(f), !n) return ft.apply(i, et.call(u, 0)), i;
							break
						}
					}
				}
			...
			function pi() {}
			var nt, ot, r, st, oi, bt, tt, ht, it, s, h, c, a, rt, ct, ut, kt, f = "sizzle" + -new Date,
				k = n.document,
				o = {},
				v = 0,
				wi = 0,
			...
			it = u.setDocument = function(n) {
				...
				return i === s || i.nodeType !== 9 || !i.documentElement ? s : (s = i, h = i.documentElement, c = oi(i), o.tagNameNoComments = b(function(n) {
					...
					if (n === "*") {
						for (; i = f[u]; u++) i.nodeType === 1 && r.push(i);
						return r
					}
					return f
					...
					ct.call(n, "[s!='']:x");
					rt.push("!=", gt)
				}), a = new RegExp(a.join("|")), rt = new RegExp(rt.join("|")), ut = ti(h.contains) || h.compareDocumentPosition ? function(n, t) {
					...
					var r;
					return n === t ? (tt = !0, 0) : (r = t.compareDocumentPosition && n.compareDocumentPosition && n.compareDocumentPosition(t)) ? r & 1 || n.parentNode && n.parentNode.nodeType === 11 ? n === i || ut(k, n) ? -1 : t === i || ut(k, t) ? 1 : 0 : r & 4 ? -1 : 1 : n.compareDocumentPosition ? -1 : 1
				} : function(n, t) {
					var r, u = 0,
						o = n.parentNode,
						s = t.parentNode,
					...
					if (n.sourceIndex && t.sourceIndex) return (~t.sourceIndex || li) - (ut(k, n) && ~n.sourceIndex || li);
					if (o && s) {
	...
	i.fn.extend({
		find: function(n) {
			var t, r, u;
			if (typeof n != "string") return u = this, this.pushStack(i(n).filter(function() {
				for (t = 0; t < u.length; t++)
					if (i.contains(u[t], this)) return !0
			}));
			for (r = [], t = 0; t < this.length; t++) i.find(n, this[t], r);
		...
		not: function(n) {
			return this.pushStack(hr(this, n, !1))
		},
		filter: function(n) {
			return this.pushStack(hr(this, n, !0))
		},
		is: function(n) {
			return !!n && (typeof n == "string" ? or.test(n) ? i(n, this.context).index(this[0]) >= 0 : i.filter(n, this).length > 0 : this.filter(n).length > 0)
		},
		closest: function(n, t) {
			for (var r, f = 0, o = this.length, u = [], e = or.test(n) || typeof n != "string" ? i(n, t || this.context) : 0; f < o; f++)
	...
	i.each({
		...
		next: function(n) {
			return sr(n, "nextSibling")
		},
		prev: function(n) {
			return sr(n, "previousSibling")
		},
		nextAll: function(n) {
		...
		i.fn[n] = function(r, u) {
			...
			return te.test(n) || (u = r), u && typeof u == "string" && (f = i.filter(u, f)), f = this.length > 1 && !ue[n] ? i.unique(f) : f, this.length > 1 && ie.test(n) && (f = f.reverse()), this.pushStack(f)
		}
	});
	i.extend({
	...
	var lr = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
		...
		le = cr(r),
		ei = le.appendChild(r.createElement("div"));
	e.optgroup = e.option;
	...
	i.fn.extend({
		...
		remove: function(n, t) {
			for (var r, f = 0;
				(r = this[f]) != null; f++)(!n || i.filter(n, [r]).length > 0) && (t || r.nodeType !== 1 || i.cleanData(u(r)), r.parentNode && (t && i.contains(r.ownerDocument, r) && oi(u(r, "script")), r.parentNode.removeChild(r)));
			return this
		},
		empty: function() {
			for (var n, t = 0;
		...
		html: function(n) {
			return i.access(this, function(n) {
				var r = this[0] || {},
					f = 0,
					o = this.length;
				if (n === t) return r.nodeType === 1 ? r.innerHTML.replace(fe, "") : t;
				if (typeof n == "string" && !oe.test(n) && (i.support.htmlSerialize || !ar.test(n)) && (i.support.leadingWhitespace || !ui.test(n)) && !e[(yr.exec(n) || ["", ""])[1].toLowerCase()]) {
					n = n.replace(vr, "<$1><\/$2>");
					try {
		...
		replaceWith: function(n) {
			...
			return t || typeof n == "string" || (n = i(n).not(this).detach()), this.domManip([n], !0, function(n) {
				var t = this.nextSibling,
					r = this.parentNode;
				(r && this.nodeType === 1 || this.nodeType === 11) && (i(this).remove(), t ? t.parentNode.insertBefore(n, t) : r.appendChild(n))
			})
		},
		detach: function(n) {
		...
		domManip: function(n, r, f) {
			...
			var s, c, h, l, e, y, o = 0,
				...
				v = n[0],
				p = i.isFunction(v);
			if (p || !(a <= 1 || typeof v != "string" || i.support.checkClone || !se.test(v))) return this.each(function(i) {
				var u = w.eq(i);
				p && (n[0] = v.call(this, i, r ? u.html() : t));
				u.domManip(n, r, f)
			});
			if (a && (s = i.buildFragment(n, this[0].ownerDocument, !1, this), c = s.firstChild, s.childNodes.length === 1 && (s = c), c)) {
				for (r = r && i.nodeName(c, "tr"), h = i.map(u(s, "script"), br), l = h.length; o < a; o++) e = s, o !== b && (e = i.clone(e, !0, !0), l && i.merge(h, u(e, "script"))), f.call(r && i.nodeName(this[o], "table") ? ae(this[o], "tbody") : this[o], e, o);
				if (l)
					for (y = h[h.length - 1].ownerDocument, i.map(h, kr), o = 0; o < l; o++) e = h[o], wr.test(e.type || "") && !i._data(e, "globalEval") && i.contains(y, e) && (e.src ? i.ajax({
						url: e.src,
						type: "GET",
						dataType: "script",
						async: !1,
						global: !1,
						throws: !0
					}) : i.globalEval((e.text || e.textContent || e.innerHTML || "").replace(ce, "")));
				s = c = null
			}
			return this
		}
	...
	i.each({
		...
		i.fn[n] = function(n) {
			for (var u, r = 0, f = [], e = i(n), o = e.length - 1; r <= o; r++) u = r === o ? this : this.clone(!0), i(e[r])[t](u), pt.apply(f, u.get());
			return this.pushStack(f)
		}
	});
	i.extend({
		clone: function(n, t, r) {
			var f, s, h, e, o, c = i.contains(n.ownerDocument, n);
			if (i.support.html5Clone || i.isXMLDoc(n) || !ar.test("<" + n.nodeName + ">") ? o = n.cloneNode(!0) : (ei.innerHTML = n.outerHTML, ei.removeChild(o = ei.firstChild)), (!i.support.noCloneEvent || !i.support.noCloneChecked) && (n.nodeType === 1 || n.nodeType === 11) && !i.isXMLDoc(n))
				for (f = u(o), s = u(n), e = 0;
					(h = s[e]) != null; ++e) f[e] && ve(h, f[e]);
			if (t)
				if (r)
					for (s = s || u(n), f = f || u(o), e = 0;
						(h = s[e]) != null; e++) dr(h, f[e]);
				else dr(n, o);
			return f = u(o, "script"), f.length > 0 && oi(f, !c && u(n, "script")), f = s = h = null, o
		},
		buildFragment: function(n, t, r, f) {
			for (var w, o, y, s, l, p, h, b = n.length, a = cr(t), c = [], v = 0; v < b; v++)
				if (o = n[v], o || o === 0)
				...
				if (!i.support.leadingWhitespace && ui.test(o) && c.push(t.createTextNode(ui.exec(o)[0])), !i.support.tbody)
					for (o = y === "table" && !pr.test(o) ? s.firstChild : l[1] === "<table>" && !pr.test(o) ? s : 0, h = o && o.childNodes.length; h--;) i.nodeName(p = o.childNodes[h], "tbody") && !p.childNodes.length && o.removeChild(p);
				for (i.merge(c, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
				s = a.lastChild
			} else c.push(t.createTextNode(o));
			for (s && a.removeChild(s), i.support.appendChecked || i.grep(u(c, "input"), ye), v = 0; o = c[v++];)
				if ((!f || i.inArray(o, f) === -1) && (w = i.contains(o.ownerDocument, o), s = u(a.appendChild(o), "script"), w && oi(s), r))
		...
		cleanData: function(n, t) {
			for (var f, u, r, e, h = 0, o = i.expando, s = i.cache, c = i.support.deleteExpando, l = i.event.special;
				...
				if ((t || i.acceptData(r)) && (u = r[o], f = u && s[u], f)) {
					...
					s[u] && (delete s[u], c ? delete r[o] : typeof r.removeAttribute != "undefined" ? r.removeAttribute(o) : r[o] = null, p.push(u))
				}
		}
	});
	var l, a, nt, si = /alpha\([^)]*\)/i,
		pe = /opacity\s*=\s*([^)]*)/,
	...
	i.fn.extend({
		css: function(n, r) {
			return i.access(this, function(n, r, u) {
				var e, o, s = {},
					f = 0;
				if (i.isArray(r)) {
					for (e = a(n), o = r.length; f < o; f++) s[r[f]] = i.css(n, r[f], !1, e);
					return s
				}
		...
		toggle: function(n) {
			...
			return this.each(function() {
				(t ? n : tt(this)) ? i(this).show(): i(this).hide()
			})
		}
	});
	i.extend({
		...
		style: function(n, r, u, f) {
			if (n && n.nodeType !== 3 && n.nodeType !== 8 && n.style) {
				var o, s, e, h = i.camelCase(r),
					c = n.style;
				if (r = i.cssProps[h] || (i.cssProps[h] = ru(c, h)), e = i.cssHooks[r] || i.cssHooks[h], u !== t) {
					if (s = typeof u, s === "string" && (o = de.exec(u)) && (u = (o[1] + 1) * o[2] + parseFloat(i.css(n, r)), s = "number"), u == null || s === "number" && isNaN(u)) return;
		...
		css: function(n, r, u, f) {
			...
			return (r = i.cssProps[s] || (i.cssProps[s] = ru(n.style, s)), o = i.cssHooks[r] || i.cssHooks[s], o && "get" in o && (e = o.get(n, !0, u)), e === t && (e = l(n, r, f)), e === "normal" && r in tu && (e = tu[r]), u) ? (h = parseFloat(e), u === !0 || i.isNumeric(h) ? h || 0 : e) : e
		},
	...
	n.getComputedStyle ? (a = function(t) {
		...
		var s, h, c, o = u || a(n),
			...
			f = n.style;
		return o && (e !== "" || i.contains(n.ownerDocument, n) || (e = i.style(n, r)), st.test(e) && gr.test(r) && (s = f.width, h = f.minWidth, c = f.maxWidth, f.minWidth = f.maxWidth = f.width = e, e = o.width, f.width = s, f.minWidth = h, f.maxWidth = c)), e
		...
		var s, e, o, h = r || a(n),
			u = h ? h[i] : t,
			f = n.style;
		return u == null && f && f[i] && (u = f[i]), st.test(u) && !we.test(i) && (s = f.left, e = n.runtimeStyle, o = e && e.left, o && (e.left = n.currentStyle.left), f.left = i === "fontSize" ? "1em" : u, u = f.pixelLeft + "px", f.left = s, o && (e.left = o)), u === "" ? "auto" : u
	});
	i.each(["height", "width"], function(n, t) {
		i.cssHooks[t] = {
			get: function(n, r, u) {
				if (r) return n.offsetWidth === 0 && be.test(i.css(n, "display")) ? i.swap(n, ge, function() {
					return ou(n, t, u)
				}) : ou(n, t, u)
			},
			set: function(n, r, u) {
				var f = u && a(n);
				return fu(n, r, u ? eu(n, t, u, i.support.boxSizing && i.css(n, "boxSizing", !1, f) === "border-box", f) : 0)
			}
		}
	});
	i.support.opacity || (i.cssHooks.opacity = {
		get: function(n, t) {
			return pe.test((t && n.currentStyle ? n.currentStyle.filter : n.style.filter) || "") ? .01 * parseFloat(RegExp.$1) + "" : t ? "1" : ""
		},
		set: function(n, t) {
			var r = n.style,
				u = n.currentStyle,
			...
			(r.zoom = 1, (t >= 1 || t === "") && i.trim(f.replace(si, "")) === "" && r.removeAttribute && (r.removeAttribute("filter"), t === "" || u && !u.filter)) || (r.filter = si.test(f) ? f.replace(si, e) : f + " " + e)
		}
	});
	i(function() {
		...
		!i.support.pixelPosition && i.fn.position && i.each(["top", "left"], function(n, t) {
			i.cssHooks[t] = {
				get: function(n, r) {
					if (r) return r = l(n, t), st.test(r) ? i(n).position()[t] + "px" : r
				}
			}
		})
	});
	...
	i.each({
		...
		i.cssHooks[n + t] = {
			expand: function(i) {
				for (var r = 0, f = {}, u = typeof i == "string" ? i.split(" ") : [i]; r < 4; r++) f[n + v[r] + t] = u[r] || u[r - 2] || u[0];
				return f
			}
		};
		gr.test(n) || (i.cssHooks[n + t].set = fu)
	});
	var no = /%20/g,
		to = /\[\]$/,
		cu = /\r?\n/g,
		io = /^(?:submit|button|image|reset)$/i,
	...
	i.fn.extend({
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var n = this.type;
				return this.name && !i(this).is(":disabled") && ro.test(this.nodeName) && !io.test(n) && (this.checked || !fi.test(n))
			}).map(function(n, t) {
				var r = i(this).val();
	...
	y = au.exec(s.toLowerCase()) || [];
	i.fn.load = function(n, r, u) {
		if (typeof n != "string" && vu) return vu.apply(this, arguments);
		var f, s, h, e = this,
			o = n.indexOf(" ");
		return o >= 0 && (f = n.slice(o, n.length), n = n.slice(0, o)), i.isFunction(r) ? (u = r, r = t) : r && typeof r == "object" && (s = "POST"), e.length > 0 && i.ajax({
			url: n,
			type: s,
			dataType: "html",
			data: r
	...
	i.extend({
		...
		ajaxSetup: function(n, t) {
			return t ? vi(vi(n, i.ajaxSettings), t) : vi(i.ajaxSettings, n)
		},
		ajaxPrefilter: wu(yu),
		ajaxTransport: wu(ai),
		ajax: function(n, r) {
			function k(n, r, o, s) {
				var a, k, w, rt, y, v = r;
				h !== 2 && (h = 2, g && clearTimeout(g), l = t, d = s || "", f.readyState = n > 0 ? 4 : 0, o && (rt = so(u, f, o)), n >= 200 && n < 300 || n === 304 ? (u.ifModified && (y = f.getResponseHeader("Last-Modified"), y && (i.lastModified[e] = y), y = f.getResponseHeader("etag"), y && (i.etag[e] = y)), n === 304 ? (a = !0, v = "notmodified") : (a = ho(u, rt), v = a.state, k = a.data, w = a.error, a = !w)) : (w = v, (n || !v) && (v = "error", n < 0 && (n = 0))), f.status = n, f.statusText = (r || v) + "", a ? tt.resolveWith(c, [k, v, f]) : tt.rejectWith(c, [f, v, w]), f.statusCode(b), b = t, p && nt.trigger(a ? "ajaxSuccess" : "ajaxError", [f, u, a ? k : w]), it.fireWith(c, [f, v]), p && (nt.trigger("ajaxComplete", [f, u]), --i.active || i.event.trigger("ajaxStop")))
			}
			typeof n == "object" && (r = n, n = t);
			r = r || {};
			var l, e, d, w, g, a, p, v, u = i.ajaxSetup({}, r),
				c = u.context || u,
				...
				f = {
					...
					getResponseHeader: function(n) {
						...
						if (h === 2) {
							if (!w)
								for (w = {}; t = fo.exec(d);) w[t[1].toLowerCase()] = t[2];
							t = w[n.toLowerCase()]
						}
			...
			if (tt.promise(f).complete = it.add, f.success = f.done, f.error = f.fail, u.url = ((n || u.url || s) + "").replace(uo, "").replace(oo, y[1] + "//"), u.type = r.method || r.type || u.method || u.type, u.dataTypes = i.trim(u.dataType || "*").toLowerCase().match(o) || [""], u.crossDomain == null && (a = au.exec(u.url.toLowerCase()), u.crossDomain = !!(a && (a[1] !== y[1] || a[2] !== y[2] || (a[3] || (a[1] === "http:" ? 80 : 443)) != (y[3] || (y[1] === "http:" ? 80 : 443))))), u.data && u.processData && typeof u.data != "string" && (u.data = i.param(u.data, u.traditional)), bu(yu, u, r, f), h === 2) return f;
			p = u.global;
			p && i.active++ == 0 && i.event.trigger("ajaxStart");
			u.type = u.type.toUpperCase();
			u.hasContent = !eo.test(u.type);
			e = u.url;
			u.hasContent || (u.data && (e = u.url += (li.test(e) ? "&" : "?") + u.data, delete u.data), u.cache === !1 && (u.url = lu.test(e) ? e.replace(lu, "$1_=" + ci++) : e + (li.test(e) ? "&" : "?") + "_=" + ci++));
			...
			f.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + (u.dataTypes[0] !== "*" ? ", " + pu + "; q=0.01" : "") : u.accepts["*"]);
			for (v in u.headers) f.setRequestHeader(v, u.headers[v]);
			if (u.beforeSend && (u.beforeSend.call(c, f, u) === !1 || h === 2)) return f.abort();
			ft = "abort";
			for (v in {
					success: 1,
					error: 1,
	...
	i.ajaxSetup({
		...
		jsonpCallback: function() {
			var n = yi.pop() || i.expando + "_" + ci++;
			return this[n] = !0, n
		}
	});
	i.ajaxPrefilter("json jsonp", function(r, u, f) {
		var e, s, o, h = r.jsonp !== !1 && (ht.test(r.url) ? "url" : typeof r.data == "string" && !(r.contentType || "").indexOf("application/x-www-form-urlencoded") && ht.test(r.data) && "data");
		if (h || r.dataTypes[0] === "jsonp") return e = r.jsonpCallback = i.isFunction(r.jsonpCallback) ? r.jsonpCallback() : r.jsonpCallback, h ? r[h] = r[h].replace(ht, "$1" + e) : r.jsonp !== !1 && (r.url += (li.test(r.url) ? "&" : "?") + r.jsonp + "=" + e), r.converters["script json"] = function() {
			return o || i.error(e + " was not called"), o[0]
		}, r.dataTypes[0] = "json", s = n[e], n[e] = function() {
			o = arguments
		}, f.always(function() {
			n[e] = s;
			r[e] && (r.jsonpCallback = u.jsonpCallback, yi.push(e));
			o && i.isFunction(s) && s(o[0]);
			o = s = t
		}), "script"
	});
	ku = 0;
	ct = n.ActiveXObject && function() {
		for (var n in k) k[n](t, !0)
	};
	i.ajaxSettings.xhr = n.ActiveXObject ? function() {
		return !this.isLocal && du() || co()
	} : du;
	d = i.ajaxSettings.xhr();
	i.support.cors = !!d && "withCredentials" in d;
	d = i.support.ajax = !!d;
	d && i.ajaxTransport(function(r) {
		if (!r.crossDomain || i.support.cors) {
			...
			return {
				send: function(f, e) {
					...
					u = function(n, f) {
						...
						try {
							if (u && (f || o.readyState === 4))
								if (u = t, h && (o.onreadystatechange = i.noop, ct && delete k[h]), f) o.readyState !== 4 && o.abort();
								else {
									c = {};
									s = o.status;
									l = o.responseXML;
					...
					r.async ? o.readyState === 4 ? setTimeout(u) : (h = ++ku, ct && (k || (k = {}, i(n).unload(ct)), k[h] = u), o.onreadystatechange = u) : u()
				},
				abort: function() {
					u && u(t, !0)
				}
	...
	var g, lt, lo = /^(?:toggle|show|hide)$/,
		ao = new RegExp("^(?:([+-])=|)(" + ft + ")([a-z%]*)$", "i"),
		vo = /queueHooks$/,
		at = [wo],
		it = {
			"*": [function(n, t) {
	...
	i.Animation = i.extend(nf, {
		tweener: function(n, t) {
			...
			for (var r, u = 0, f = n.length; u < f; u++) r = n[u], it[r] = it[r] || [], it[r].unshift(t)
		},
		prefilter: function(n, t) {
			t ? at.unshift(n) : at.push(n)
		}
	});
	i.Tween = f;
	f.prototype = {
	...
	f.propHooks = {
		_default: {
			get: function(n) {
				var t;
				return n.elem[n.prop] != null && (!n.elem.style || n.elem.style[n.prop] == null) ? n.elem[n.prop] : (t = i.css(n.elem, n.prop, "auto"), !t || t === "auto" ? 0 : t)
			},
			set: function(n) {
	...
	i.each(["toggle", "show", "hide"], function(n, t) {
		...
		i.fn[t] = function(n, i, u) {
			return n == null || typeof n == "boolean" ? r.apply(this, arguments) : this.animate(vt(t, !0), n, i, u)
		}
	});
	i.fn.extend({
		...
		stop: function(n, r, u) {
			...
			return typeof n != "string" && (u = r, r = n, n = t), r && n !== !1 && this.queue(n || "fx", []), this.each(function() {
				...
				if (t) r[t] && r[t].stop && f(r[t]);
					...
					for (t in r) r[t] && r[t].stop && vo.test(t) && f(r[t]);
	...
	i.fx.tick = function() {
		var u, n = i.timers,
			r = 0;
		for (g = i.now(); r < n.length; r++) u = n[r], u() || n[r] !== u || n.splice(r--, 1);
		n.length || i.fx.stop();
		g = t
	};
	...
	i.fx.interval = 13;
	i.fx.start = function() {
		lt || (lt = setInterval(i.fx.tick, i.fx.interval))
	};
	i.fx.stop = function() {
		clearInterval(lt);
		lt = null
	...
	i.fn.offset = function(n) {
		...
		var r, e, f = {
			...
			u = this[0],
			o = u && u.ownerDocument;
		if (o) return (r = o.documentElement, !i.contains(r, u)) ? f : (typeof u.getBoundingClientRect != "undefined" && (f = u.getBoundingClientRect()), e = tf(o), {
