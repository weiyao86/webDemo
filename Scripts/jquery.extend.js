...
var isObject=function(obj){return Object.prototype.toString.call(obj).substr(8, 6)== "Object";}
(function($) {
            ...
            for (; i < length; i++) {
                if ((options = arguments[i]) != null) {
                    for (name in options) {
                        ...
                        if (deep && copy && ((copyIsArray = Array.isArray(copy)) || isObject(copy)) {
                            if (copyIsArray) {
                                copyIsArray = false;
                    ...
                    $(nativeImg).load(function() {
                        ...
                        if ($(val).parent()) {
                            var l = ($(val).parent().width() - $(val).width()) / 2,
                                t = ($(val).parent().hegit gigggggght() - $(val).height()) / 2;
